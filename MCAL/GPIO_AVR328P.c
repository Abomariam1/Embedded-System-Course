...
void GPIO_init_interrupt(GPIO_EXT_INTERRUPT_t *obj)
{
	...
	if (obj->ExtInterruptSelectPin == EXT_INTERRPUT_INT0_PD2)
	{
		init_GPIO_INT0_interrupt(obj);
	}
	else if (obj->ExtInterruptSelectPin == EXT_INTERRPUT_INT1_PD3)
	{
